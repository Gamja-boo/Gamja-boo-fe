...
export default function CustomizingScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* 뒤로가기 버튼 */}
      <TouchableOpacity style={styles.backCon} onPress={() => router.push('/main/character')}>
        <Back />
      </TouchableOpacity>
      ...
      {selected === 'skin' && (
        <View style={styles.chooseCon}>
          <ChooseSkin items={skinItems} onSelect={setSelectedSkin} />
        </View>
      )}

      {selected === 'cloth' && (
        <View style={styles.chooseCon}>
          <ChooseCloth items={clothItems} onSelect={setSelectedCloth} />
        </View>
      )}

      {selected === 'accessory' && (
        <View style={styles.chooseCon}>
          <ChooseAccessory items={accessoryItems} onSelect={setSelectedAccessory} />
        </View>
      )}
