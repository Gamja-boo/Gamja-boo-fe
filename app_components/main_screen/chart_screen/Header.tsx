...
interface typeOfProps {
  ...
  setgraphVisible: Dispatch<SetStateAction<boolean>>;
  chartAnimation: () => () => void;
}
...
export const Header = ({
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={() => router.push('/main')} style={styles.homeButton}>
      ...
      <TouchableOpacity style={styles.calendarButton}>
        <Calendar fill="#FFFFFF" height={screenWidth * 0.08} width={screenWidth * 0.08} />
      </TouchableOpacity>
    </View>
  );
};
